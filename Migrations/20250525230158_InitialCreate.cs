    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "UserProfiles",
                columns: new[] { "Id", "ImagePath", "Username" },
                values: new object[] { 1, null, "admin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "PasswordHash", "Role", "Token", "Username" },
                values: new object[] { 1, "$2a$11$iufXijExmP0IomkY8ka14O3eOUW5nGo.8es3dMPy2iQZ7.wglbTzi", "Admin", "f07200eb-1a16-401d-9d67-0360932e3aab", "admin" });
